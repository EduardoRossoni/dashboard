...
import { AiShoppingCar, FiShoppingCart } from 'react-icons/fi'
...
const NavButton = ({ title, customFunc, icon, color, dotColor }) => (
  <TooltipComponent content={title} position="BottomCenter">
    <botton type="button" onClick={customFunc} style={{ color }} className="relative text-xl rounded full
